...
DomainErrorTranslator._directories = {
  ...
  'INVALID_OWNER': new AuthorizationError('tidak memiliki hak akses untuk komentar ini'),
  ...
  'DETAIL_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat komentar baru karena properti yang dibutuhkan tidak ada'),
  'DETAIL_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat komentar baru karena tipe data tidak sesuai'),
